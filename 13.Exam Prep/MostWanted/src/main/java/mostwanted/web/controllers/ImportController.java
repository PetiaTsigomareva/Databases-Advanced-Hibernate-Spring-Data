...
public class ImportController extends BaseController {
    ...
    public ModelAndView importJson() {
        boolean[] areImported = new boolean[]{this.townService.townsAreImported(), this.districtService.districtsAreImported(), this.racerService.racersAreImported(), this.carService.carsAreImported()};
    ...
    public ModelAndView importXml() {
        boolean[] areImported = new boolean[]{this.raceEntryService.raceEntriesAreImported(), this.raceService.racesAreImported()};
