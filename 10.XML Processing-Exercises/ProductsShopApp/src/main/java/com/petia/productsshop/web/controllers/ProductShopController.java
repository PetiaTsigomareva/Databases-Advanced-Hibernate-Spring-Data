package com.petia.productsshop.web.controllers;

import com.google.gson.Gson;
import com.petia.productsshop.domain.dtos.*;
import com.petia.productsshop.service.CategoryService;
import com.petia.productsshop.service.ProductService;
import com.petia.productsshop.service.UserService;
...
public class ProductShopController implements CommandLineRunner {
    ...
    private final static String USER_FILE_PATH = "C:\\Projects\\softuni\\Databases Frameworks - Hibernate & Spring Data\\09.JSON Processing-Exercises\\ProductsShopApp\\src\\main\\resources\\files\\users.json";
    private final static String CATEGORIES_FILE_PATH = "C:\\Projects\\softuni\\Databases Frameworks - Hibernate & Spring Data\\09.JSON Processing-Exercises\\ProductsShopApp\\src\\main\\resources\\files\\categories.json";
    private final static String PRODUCTS_FILE_PATH = "C:\\Projects\\softuni\\Databases Frameworks - Hibernate & Spring Data\\09.JSON Processing-Exercises\\ProductsShopApp\\src\\main\\resources\\files\\products.json";
    private final static String PRODUCT_IN_RANGE_PATH = "C:\\Projects\\softuni\\Databases Frameworks - Hibernate & Spring Data\\09.JSON Processing-Exercises\\ProductsShopApp\\src\\main\\resources\\files\\output\\products-in-range.json";
    ...
    private final static String USER_SOLD_PRODUCT_PATH = "C:\\Projects\\softuni\\Databases Frameworks - Hibernate & Spring Data\\09.JSON Processing-Exercises\\ProductsShopApp\\src\\main\\resources\\files\\output\\user_sold-products.json";
    private final static String CATEGORIES_BY_PRODUCTS_PATH = "C:\\Projects\\softuni\\Databases Frameworks - Hibernate & Spring Data\\09.JSON Processing-Exercises\\ProductsShopApp\\src\\main\\resources\\files\\output\\categories-by-products.json";
